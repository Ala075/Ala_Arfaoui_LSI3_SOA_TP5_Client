 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service.TP5/", wsdlLocation = "http://localhost:8085/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://service.TP5/", "BanqueServiceService");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://service.TP5/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.TP5/", "BanqueServicePort"), BanqueService.class, features);
    }
