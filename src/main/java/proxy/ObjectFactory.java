...
public class ObjectFactory {
    ...
    private final static QName _Compte_QNAME = new QName("http://service.TP5/", "compte");
    private final static QName _Conversion_QNAME = new QName("http://service.TP5/", "conversion");
    private final static QName _ConversionResponse_QNAME = new QName("http://service.TP5/", "conversionResponse");
    private final static QName _GetComptes_QNAME = new QName("http://service.TP5/", "getComptes");
    private final static QName _GetComptesResponse_QNAME = new QName("http://service.TP5/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://service.TP5/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://service.TP5/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://service.TP5/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://service.TP5/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://service.TP5/", name = "getComptesResponse")
